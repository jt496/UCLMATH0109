...
#check powersetCard_self
#check powersetCard_eq_empty
#check mem_filter
#check pair_comm
#check mem_image
#check mem_powersetCard
#check card_eq_one
#check mem_singleton_self
#check powersetCard_succ_insert
#check mem_union
#check not_mem_mono
...
→ RamseyOf b (s + 1) t → RamseyOf (a + b) (s + 1) (t + 1):=by
  sorry
...
#check max'_le
#check le_min'
#check card_eq_three -- a good place to start with the next lemma
#check card_eq_two
#check min'_mem
#check min'_lt_max'_of_card
#check card_erase_of_mem
#check mem_erase_of_ne_of_mem
#check ne_of_mem_erase
#check mem_powersetCard
#check mem_of_mem_erase
#check exists_smaller_set
#check powersetCard_mono

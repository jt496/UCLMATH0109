...
in any expression containging `a`.
...
-/
-- 09 
example (h1 : a = b) ( h2: b = c) (h3 : d= c) (h4 : e = d) : e = a :=
by
  rwa [h1,h2, ← h3]


-- 10
example (h1 : a = b) ( h2: b = c) (h3 : d= c) (h4 : e = d) : a = e :=
by
  rw [← h4] at h3 
  rw [← h3] at h2
  rwa [h1]
...
since Lean now needs to decide how to pick `i` and `j`. 
